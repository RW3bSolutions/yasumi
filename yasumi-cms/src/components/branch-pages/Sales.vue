...
export default defineComponent({
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          name: 'name',
          label: 'CUSTOMER NAME',
          field: row => row.booking.customer ? row.booking.customer.name : '-',
          align: 'left',
          sortable: true
        },
        {
          name: 'contact_no',
          label: 'CONTACT NO.',
          field: row => row.booking.customer ? row.booking.customer.contact_no : '-',
          align: 'left',
          sortable: true
        },
        {
  ...
  methods: {
    ...
    index () {
      this.$api.get('admin/therapists?branch_id=' + this.$route.params.id, {
        headers: {
      ...
      this.$api.get('admin/sales?branch_id=' + this.$route.params.id, {
        headers: {
          Authorization: 'Bearer ' + localStorage.getItem('token')
        }
      })
