<template>
  <div class="row q-px-md q-py-xs">
    <div class="col-12 col-md-6 q-py-sm self-center text-weight-medium">
      TOTAL COMMISSIONS: {{ numberFormat(totalCommissions) }}
    </div>
...
export default defineComponent({
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          name: 'contact_no',
          label: 'CONTACT NO.',
          field: row => row.booking.contact_no,
          align: 'left',
          sortable: true
        },
        {
  ...
  methods: {
    ...
    index () {
      this.$api.get('admin/commissions?branch_id=' + this.$route.params.id, {
        headers: {
